...
| Seed data | `/data/shows.json` + `/data/justwatch_shows.json` | Curated fallback plus generated JustWatch availability |
...
- **Show data source.** Curated data comes from `shows.json`; JustWatch catalog ingestion writes 250 poster-backed records to `justwatch_shows.json`.
