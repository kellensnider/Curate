...
export default function SubscriptionsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ position: 'relative' }}>
      ...
      <div className="max-w-3xl mx-auto" style={{ paddingLeft: 24, paddingRight: 24, paddingBottom: 40 }}>
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} className="mb-8" style={{ paddingTop: 28 }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: 'white', margin: 0 }}>Current Subscriptions</h1>
